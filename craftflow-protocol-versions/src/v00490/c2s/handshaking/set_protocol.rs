...
impl crate::Packet for SetProtocol {
	...
	type Version = crate::v00490::C2S;
	type State = crate::v00490::c2s::Handshaking;

	fn into_state_enum(self) -> Self::State {
		crate::v00490::c2s::Handshaking::SetProtocol(self)
	}
	fn into_version_enum(self) -> Self::Version {
		crate::v00490::C2S::Handshaking(self.into_state_enum())
	}
	fn into_direction_enum(self) -> Self::Direction {
		crate::C2S::V00490(self.into_version_enum())
	}
}
